...
define run-in-test-server
	docker run --rm -it \
		...
		-w ${DOCKER_WORKDIR} \
		-v /home/risha/.minikube:/home/risha/.minikube \
...
test-tools-image:
	docker build --network host --build-arg UID=$(shell id -u) -t $(TEST_TOOLS_PREFIX)$(TEST_TOOLS_IMAGE) -f test/container/Dockerfile .
